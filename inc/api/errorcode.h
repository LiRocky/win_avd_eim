...
#define Err_Not_Implemented		(Result)(Err_Base + 22)
...
#define Err_Local_Database_Failure		(Result)(Err_Base + 29)
...
#define Err_IM_Base		2000
/* Returned when don't set host(IP)*/
#define Err_Http_Proto			(Result)(Err_IM_Base + 1)
/* Returned when don't set host(IP)*/
#define Err_Host_Not_Set		(Result)(Err_IM_Base + 2)
/* Returned when callback is null */
#define Err_Callback_Null		(Result)(Err_IM_Base + 3)
/* Returned when login repeated */
#define Err_Login_Already		(Result)(Err_IM_Base + 4)
/* Returned when login repeated */
#define Err_Has_IM				(Result)(Err_IM_Base + 5)
